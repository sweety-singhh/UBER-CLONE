...
const Home = () => {
    ...
    const [showLiveTracking, setShowLiveTracking] = useState(true); // State to control LiveTracking visibility
    ...
    const handleInputClick = () => {
        setShowLiveTracking(false); // Hide the LiveTracking map when an input is clicked
    };
    ...
    async function findTrip() {
        ...
        setPanelOpen(false);
        setShowLiveTracking(true); // Show the LiveTracking map again
    ...
    return (
        <div className="h-screen relative overflow-hidden">
            ...
            <div className="h-screen w-screen">
                {/* Conditionally render LiveTracking */}
